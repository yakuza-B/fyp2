...
def load_model():
    ...
    if os.path.exists(model_path):
        ...
        st.error("❌ Model file not found! Please ensure 'best_caries_model.keras' is in the repository.")
        return None
...
with col2:
    if uploaded_file is not None:
        if model is None:
            st.warning("Please upload the model file to the repository to enable predictions.")
        else:
            # 1. Load Image
            ...
            # Using a medical threshold to prioritize Recall
